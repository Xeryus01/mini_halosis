                    ...
                    <div class="card my-4 shadow-sm">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-3 pb-2 px-3 d-flex align-items-center">
                                ...
                                <h5 class="text-white text-capitalize mb-0">Tim PMSS</h5>
                            </div>
                        </div>
                                ...
                                <table class="table table-hover table-team mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="team-name">Fahrur Rozi, SST, M.T</div>
                                                        <div class="team-email">fahrurrozi@bps.go.id</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="team-role">Koordinator Sub Tim PMSS</div>
                                                <div class="text-muted" style="font-size:0.9rem;">Pranata Komputer Ahli Muda BPS Provinsi</div>
                                            </td>
                                            <td class="text-center team-grade">Penata Tingkat I / IIId</td>
                                            <td class="text-center">
                                                <span class="badge bg-gradient-info text-white">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="team-name">Ridho Akbar, SST, M.T</div>
                                                        <div class="team-email">ridho.akbar@bps.go.id</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="team-role">Anggota Sub Tim PMSS</div>
                                                <div class="text-muted" style="font-size:0.9rem;">Pranata Komputer Ahli Muda</div>
                                            </td>
                                            <td class="text-center team-grade">Pembina / IVa</td>
                                            <td class="text-center">
                                                <span class="badge bg-gradient-info text-white">
                                                    {{ date_diff(date_create(date('d-m-Y')), date_create("01-10-2022"))->format('%y Th %m Bln') }}
                                                </span>
                                            </td>
                                            @auth
                                                @if(auth()->user()->role === 'admin')
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="team-name">Sari Sisilianingsih, SST, M.Kom.</div>
                                                        <div class="team-email">sari.sisilia@bps.go.id</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <span class="badge bg-gradient-info text-white">
                                                    {{ date_diff(date_create(date('d-m-Y')), date_create("01-06-2024"))->format('%y Th %m Bln') }}
                                                </span>
                                            </td>
                                            @auth
                                                @if(auth()->user()->role === 'admin')
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="team-name">Rahma Nurhamidah, SST</div>
                                                        <div class="team-email">rahma.nurhamidah@bps.go.id</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="team-role">Anggota Sub Tim PMSS</div>
                                                <div class="text-muted" style="font-size:0.9rem;">Statistisi Ahli Muda</div>
                                            </td>
                                            <td class="text-center team-grade">Penata Tingkat I / IIId</td>
                                            <td class="text-center">
                                                <span class="badge bg-gradient-info text-white">
                                                    {{ date_diff(date_create(date('d-m-Y')), date_create("01-02-2024"))->format('%y Th %m Bln') }}
                                                </span>
                                            </td>
                                            @auth
                                                @if(auth()->user()->role === 'admin')
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('/assets/img/team-2.jpg') }}" class="avatar avatar-sm rounded-circle me-2 border border-2 border-secondary" alt="user6">
                                                    <div>
                                                        <div class="team-name">Rommel Yonatan Sianipar, S.Tr.Stat.</div>
                                                        <div class="team-email">rommel.yonatan@bps.go.id</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="team-role">Anggota Sub Tim PMSS</div>
                                                <div class="text-muted" style="font-size:0.9rem;">Statistisi Ahli Pertama</div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('/assets/img/team-2.jpg') }}" class="avatar avatar-sm rounded-circle me-2 border border-2 border-warning" alt="user7">
                                                    <div>
                                                        <div class="team-name" style="max-width:310px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">Marko Januarta Putra Mulyowidodo, S.Tr.Stat.</div>
                                                        <div class="team-email">januarta.marko@bps.go.id</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <span class="badge bg-gradient-info text-white">
                                                    {{ date_diff(date_create(date('d-m-Y')), date_create("01-01-2022"))->format('%y Th %m Bln') }}
                                                </span>
                                            </td>
                                            @auth
                                                @if(auth()->user()->role === 'admin')
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('/assets/img/team-2.jpg') }}" class="avatar avatar-sm rounded-circle me-2 border border-2 border-dark" alt="user8">
                                                    <div>
                                                        <div class="team-name">Syahrul Toha Saputra, S.Tr.Stat.</div>
                                                        <div class="team-email">syahrul.toha@bps.go.id</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
